...
const mypageRouter = require('../dist/mypage')
const registerRouter = require('../dist/register')
const createDishRouter = require('../dist/createDish')
const signoutRouter = require('../dist/signout')
const callbackRouter = require('../dist/callback')
const authRouter = require('../dist/auth')
const memoRouter = require('../dist/memo')
const rakutenRouter = require('../dist/rakuten')
const csrfRouter = require('../dist/csrf')
